...
class MetasploitModule < Msf::Encoder::Xor
  ...
  def initialize
    super(
      ...
      'Description'      => 'Context-Keyed Payload Encoder based on hostname and x64 XOR encoder. Uses an 8 byte key and takes advantage of x64 relative addressing.',
      'Author'           => [ 'sf' 'oso' ],
      'Arch'             => ARCH_X64,
      'License'          => MSF_LICENSE,
      'Platform'         => 'linux',    # TODO: windows
      'Decoder'          =>
        {
          'KeySize'      => 8,
          'KeyPack'      => 'Q',
